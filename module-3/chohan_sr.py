...
Note: If the total is 2 or 7, you receive a 10 mon bonues!
''')

purse = 5000
house_percentage = 0.12 # Set house percentage to 12%
...
while True:  # Main game loop.
    ...
    if playerWon:
        ...
        fee = int(pot * house_percentage) # Calculate house fee. 
        print('The house collects a', fee, 'mon fee.')
        purse -= fee  # The house fee is 10%.
    else:
    ...
    if total_roll == 2 or total_roll == 7:
        print(f'Congratulations! The total of you roll is {total_roll}.')
